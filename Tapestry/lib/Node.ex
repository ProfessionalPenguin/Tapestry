defmodule Proj3.Node do
  ...
  def handle_cast({:newNodeJoin, serverState, hashValue, hashList, hops, level, currentRoutingTable}, _state) do
    mainnode=hashValue
    nodes=hashList
    mainmap = %{}
...
acc
  ...
  def handle_call(:getRoutingTable, _from, {hashValue ,mainmap}) do
    {:reply , mainmap, {hashValue ,mainmap} }
  end
